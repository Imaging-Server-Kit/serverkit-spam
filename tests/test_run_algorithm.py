...
from main import SpamRegisterServer
...
def run_algorithm_server_side():
    ...
    sample_moving_image, sample_fixed_image = server.load_sample_images()
    default_params["moving_image"] = sample_moving_image
    default_params["fixed_image"] = sample_fixed_image
...
def run_algorithm_client_side():
    ...
    try:
        ...
        # Add values to the required parameters, for example an input image
        sample_moving_image, sample_fixed_image = client.get_sample_images()
        default_params["moving_image"] = sample_moving_image
        default_params["fixed_image"] = sample_fixed_image
